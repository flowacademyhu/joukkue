...
insert into users (firstname, lastname, password, role, email, date) values ('Sylvester', 'Stallone', 'Rambo1', 'subscriber', 'ramboo@gmail.com', '2000-03-07'); 
...
insert into users (firstname, lastname, password, role, email, date) values ('Michael', 'Jackson', 'WhiteSkin', 'subscriber', 'black@jacko.cum', '2004-07-03'); 
